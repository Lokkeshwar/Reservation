...
public class PrintTicket1 extends JFrame
{
	public PrintTicket1(String sFrom, String sTo, String sClass, Integer iAdult, Integer iChildren, Integer iInfant, String sBookingDate, Integer iPrice, String sTime)
	{
		JFrame f;
		f=new JFrame();
		String name=JOptionPane.showInputDialog(f,"Enter Passenger Name:");
		...
		JLabel LTicketNo=new JLabel("<html><b><font color=\"#000000\">TicketNo &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: &nbsp;</font></b><font color=\"#778899\">"+ randnum+"</font></html>");
		...
		JLabel LMadhu=new JLabel("<html><I><font color=\"#8FBC8F\">V.Madhusudhan</font></I></html>");
		JLabel LLokki=new JLabel("<html><I><font color=\"#8FBC8F\">Y.Lokkeshwar</font></I></html>");
		JLabel LSrihari=new JLabel("<html><I><font color=\"#8FBC8F\">M.Srihari balaji</font></I></html>");
		...
		LMadhu.setBounds(285,485,300,20);
		LLokki.setBounds(285,505,300,20);
		LSrihari.setBounds(285,525,300,20);
		...
		"jdbc:mysql://localhost:3306/Airline","root","root");  
		//here sonoo is database name, root is username and password  
		Statement stmt=con.createStatement(); 
		String sql="insert into ticket values('"+randnum+"','"+name+"','"+sFrom+"','"+sTo+"','"+sClass+"','"+iAdult+"','"+iChildren+"','"+iInfant+"','"+sBookingDate+"','"+sTime+"','"+iPrice+"')";
