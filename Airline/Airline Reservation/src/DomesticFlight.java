...
String[] sItem1={"Chennai"};
String[] sItem2 ={ "Bangalore", "Trivandrum ", "Delhi", "Goa", "Hyderabad", "Kolkata", "Lucknow", "Mumbai", "Vishakapatnam" };
...
LNotes = new JLabel("<html><body><p>NOTE: Ticket of Infant is Free of Cost in Domestic Flights.</body></html>");
